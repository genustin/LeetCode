...
public class P13 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new P13().romanToInt("MCDXXXVII"));
        System.out.println(new P13().romanToInt("MD"));
        System.out.println(new P13().romanToInt("MDCCC"));
        System.out.println(new P13().romanToInt("MDCCCLXXX"));
        System.out.println(new P13().romanToInt("MCM"));
        System.out.println(new P13().romanToInt("MMMCCCXXXIII"));
    }
}
